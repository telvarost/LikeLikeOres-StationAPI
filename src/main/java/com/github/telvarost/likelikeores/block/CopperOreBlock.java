...
public class CopperOreBlock extends TemplateOreBlock {
    public CopperOreBlock(Identifier identifier, int textureId) {
        super(identifier, textureId);
    }

//    @Override
//    public int getTexture(int side) {
//        return LikeLikeOres.COPPER_ORE_SETTINGS.integerSettingOreGeneration.getValue();
//    }
